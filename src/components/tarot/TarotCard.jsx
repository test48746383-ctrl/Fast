    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden rounded-xl overflow-hidden border-2 border-white/20 bg-cosmic-900">
          <div className="w-full h-full bg-[url('/assets/tarot-back.png')] bg-cover bg-center opacity-80" />
          <div className="absolute inset-0 flex items-center justify-center">
             <div className="w-12 h-12 rounded-full border border-gold-400/50 flex items-center justify-center">
               ✨
             </div>
          </div>
        </div>
        ...
        {/* Front of Card */}
        <div className="absolute inset-0 backface-hidden rotate-y-180 rounded-xl overflow-hidden bg-white border-4 border-gold-400">
           {card && (
             <>
                {/* Use placeholder colored div if no image */}
                <div className="w-full h-full bg-gradient-to-b from-slate-200 to-slate-400 relative">
                   {/* Normally card.image would go here */}
